...
public class MyMethod {
    ...
    public static double myCos(double x) {
        ...
        for (int n = 0; n < N; n++) {
            ...
            for(int k = 1; k <= 2 * n; k++) {
                //Declares a "for" loop for the variable "k = 1", the condition that "k" has to be less than or equal to "2 * n," and that "k" is increasing by +1 using the post-increment "k++"
                p3 *= x;
                //Same as "p3 = p3 * x"
            }
